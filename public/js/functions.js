...
function switchLayouts() {
	...
	(s = s.substr(0, s.indexOf("-"))),
		$(".layout-switcher").on("click", function () {
			(i =
				"admin" == s
					? e.replace("admin", "webapp")
					: e.replace("webapp", "admin")),
				(window.location.href = i);
		});
}
function changeDemoImages() {
	$("*[data-demo-src]").each(function () {
		var e = $(this).attr("data-demo-src");
		$(this).attr("src", e);
	}),
		$("*[data-demo-background]").each(function () {
			var e = $(this).attr("data-demo-background");
			$(this).attr("data-background", e);
		}),
		$("*[data-demo-href]").each(function () {
			var e = $(this).attr("data-demo-href");
			$(this).attr("href", e);
		});
}
function initBgImages() {
	$(".has-background-image").length &&
		$(".has-background-image").each(function () {
			...
			void 0 !== e && $(this).css("background-image", "url(" + e + ")");
		});
}
...
function setActivelink() {
	...
	$(".sidebar-panel .inner ul li a, .mobile-subsidebar ul li a").each(
		...
		$(".main-sidebar .sidebar-inner ul li a").each(function () {
			var i = this.href;
			e == i && $(this).closest("li").find("a").addClass("is-selected");
		}),
		$(".webapp-subnavbar-inner .center ul li a").each(function () {
			...
			if (e == i) {
				...
				var s = $(this).closest(".tab-content").attr("id");
				$(this)
					.closest(".webapp-subnavbar-inner")
					.find(".tabs ul li")
					.removeClass("is-active"),
					$("[data-tab=" + s + "]").addClass("is-active");
			}
		});
}
...
function updateSidebarNaver() {
	var e = $("[data-menu-item]").attr("data-menu-item"),
		i = $("[data-mobile-item]").attr("data-mobile-item");
	if (
		($(e).addClass("is-active"),
		$(i).addClass("is-active"),
		$("[data-naver-offset]").length)
	) {
		var s = parseInt($(".view-wrapper").attr("data-naver-offset"));
		$(".naver").removeClass("from-bottom"),
			$(".naver").css({ "margin-top": s });
	} else if ($("[data-naver-offset-bottom]").length) {
		var t = parseInt($(".view-wrapper").attr("data-naver-offset-bottom"));
		$(".naver").addClass("from-bottom"),
			$(".naver").css({ "margin-bottom": t });
	}
}
function initCollapsibleMenu() {
	$(".has-children .parent-link").on("click", function (e) {
		e.preventDefault(),
			$(this).closest(".has-children").hasClass("active")
				? ($(this).closest(".has-children").find("ul").slideToggle(),
				  $(".sidebar-panel li, .mobile-subsidebar li").removeClass("active"))
				: ($(
						".sidebar-panel .has-children ul, .mobile-subsidebar .has-children ul",
				  ).slideUp(),
				  $(this).closest(".has-children").find("ul").slideToggle(),
				  $(
						".sidebar-panel .has-children, .mobile-subsidebar .has-children",
				  ).removeClass("active"),
				  $(this).closest(".has-children").addClass("active"));
	});
}
function initWebapp() {
	var e = $(".view-wrapper").attr("data-page-title");
	$("#webapp-page-title").html(e),
		$(window).on("scroll", function () {
			$(window).scrollTop() > 10
				? $(
	...
	$(".centered-link-toggle").removeClass("is-active"),
		...
		$(".webapp-navbar .centered-link-search, #webapp-navbar-search-close").on(
			"click",
			function () {
				$("#webapp-navbar-menu, #webapp-navbar-search").toggleClass(
					"is-hidden",
				),
		...
		$(".webapp-navbar .category-selector").length &&
			($(".webapp-navbar .category-selector .category-item").on(
				"click",
				function () {
					var e = $(this).attr("data-category"),
						i = $(this).closest(".dropdown");
					i.find(".mega-menus").removeClass("is-active"),
						$("#" + e).addClass("is-active"),
						i
	...
	$(".navbar-burger").length &&
		$(".navbar-burger").on("click", function () {
			$(this).toggleClass("is-active"),
				$(".mobile-main-sidebar").hasClass("is-active")
					? $(".mobile-main-sidebar, .mobile-subsidebar").removeClass(
							"is-active",
					  )
...
function initNavbarDropdowns() {
	$(".has-dropdown").on("click", function () {
		$(".has-dropdown").removeClass("is-active"), $(this).addClass("is-active");
	}),
		$(document).on("click", function (e) {
			var i = e.target;
			$(i).is(".has-dropdown .navbar-link") ||
				$(i).parents().is(".has-dropdown") ||
				$(".has-dropdown").removeClass("is-active");
		});
}
function initDropdowns() {
	$(".dropdown-trigger").on("click", function () {
		$(".dropdown").removeClass("is-active"), $(this).addClass("is-active");
	}),
		$(document).on("click", function (e) {
			var i = e.target;
			$(i).is(".dropdown img, .kill-drop") ||
				$(i).parents().is(".dropdown") ||
				$(".dropdown").removeClass("is-active"),
				$(i).is(".kill-drop") && $(".dropdown").removeClass("is-active");
		});
}
...
function adjustDropdowns() {
	$(".dropdown:not(.user-dropdown)").each(function () {
		var e = $(this);
		$(this).offset().top + $(this).height() >= $(window).height() - 250
			? $(e).addClass("is-up")
			: $(e).removeClass("is-up");
	}),
		$(window).on("scroll", function () {
...
function initConfirm(e, i, s, t, a, o, n) {
	alertify
		.confirm("confirm")
		.set({
			transition: "fade",
...
function initChosenSelects() {
	if ($(".chosen-select-no-single").length) {
		...
		for (var i in e) e.hasOwnProperty(i) && $(i).chosen(e[i]);
	}
}
function initTabs() {
...
function initHSelect() {
	$(".h-select").on("click", function () {
		...
		$(document).click(function (e) {
			var i = e.target;
			$(i).is(".h-select") ||
				$(i).parents().is(".control") ||
				$(".h-select").removeClass("is-active");
		}),
		$(".h-select input").on("change", function () {
			var e = $(this).siblings(".option-meta").find("span").text();
			$(this).closest(".h-select").find(".select-box span").html(e);
		});
}
	...
	$(".is-combo .combo-box").on("click", function () {
		...
		$(".combo-box .box-dropdown li").on("click", function (e) {
			var i = e.target,
				...
				o = $(this).find(".item-name").text(),
				n = '<i class="' + s + '"></i>',
				l = "";
			(console.log(a),
			$(i).is(".box-dropdown li, body") ||
				$(i).parents().is(".box-dropdown") ||
			...
			t.length
				? ($(this).closest(".combo-box").find(".combo-item i").remove(),
				  ...
				  $(this)
						...
						.text(o))
				: ($(this).closest(".combo-box").find(".combo-item i").remove(),
				  $(this).closest(".combo-box").find(".combo-item").prepend(a),
				  $(this)
						.closest(".combo-box")
						.find(".combo-item .selected-item")
						.text(o)),
			$(this).hasClass("data-push")) &&
				((l =
					...
					"\n                </div>\n            </div>\n            "),
				$.when($("#quick-specs").append(l)).then(function () {
...
function initUserComboBox() {
	$(".is-combo .user-combo-box").on("click", function () {
		...
		$(".user-combo-box .box-dropdown li").on("click", function (e) {
			var i = e.target,
				s = $(this).find(".item-icon .avatar").attr("src"),
				t = $(this).find(".item-icon .badge").attr("src"),
				...
				0 == $(".stacked-combo-box li.is-active").length
					? ($("#" + t).remove(),
					  ...
					  $(this)
							...
							.find(".selected-item")
							.text("Select one or more skills"))
...
function initBigComboBox() {
	$(".big-combo-box").on("click", function () {
		...
		$(".big-combo-box .box-dropdown li").on("click", function (e) {
			var i = e.target,
				s = $(this).find(".item-icon i").attr("class"),
				t = $(this).find(".item-name span:first-child").text(),
				a = $(this).find(".item-name span:nth-child(2)").text();
			$(i).is(".box-dropdown li, body") ||
				$(i).parents().is(".box-dropdown") ||
				$(".box-dropdown").removeClass("is-active"),
				$(i).is("body") && $(".box-dropdown").removeClass("is-active"),
...
function initAccordion() {
	...
	e.each(function () {
		...
		e.find("h3").on("click", function (e) {
			...
			if ($(this).next().is(":hidden")) {
				...
				s
					...
					.next()
					.slideUp(300),
					s.find("span").removeClass("ui-accordion-icon-active"),
		...
		$(".trigger, .trigger.opened").on("click", function (e) {
...
function initAnimatedModals() {
	...
	$(".modal-trigger").length &&
		($(".modal-trigger").on("click", function () {
			(e = $(this).attr("data-modal")),
				$("#" + e).toggleClass("is-active"),
				$("#" + e + " .modal-background").toggleClass("scaleInCircle"),
				$("#" + e + " .modal-content").toggleClass("scaleIn"),
				$("#" + e + " .modal-close").toggleClass("is-hidden"),
				setTimeout(function () {
...
function initHModals() {
	var e;
	$(".h-modal-trigger").length &&
		($(".h-modal-trigger").on("click", function () {
			(e = $(this).attr("data-modal")), $("#" + e).toggleClass("is-active");
		}),
...
function initPanels() {
	var e;
	$(".right-panel-trigger").length &&
		($(".right-panel-trigger").on("click", function () {
			(e = $(this).attr("data-panel")),
				$("#" + e).addClass("is-active"),
				"search-panel" == e && $(".right-panel .search-input").focus();
		}),
...
function initSmallTextTip() {
	$(".has-small-text-tip").on("mouseenter", function () {
		if ($(this).find(".text-tip-text").width() >= 250) {
			var e = $(this).find(".text-tip-text").text();
			$.when(
				$(this).append(
					'\n                <div class="text-tooltip scaleInTooltip">\n                    <div class="tooltip-content">\n                        Some tooltip content\n                    </div>\n                </div>\n            ',
				),
			).then(function () {
				$(this).find(".text-tooltip .tooltip-content").html(e);
			});
		}
	}),
...
function initTextTip() {
	$(".has-text-tip").on("mouseenter", function () {
		if ($(this).find(".text-tip-text").width() >= 380) {
			var e = $(this).find(".text-tip-text").text();
			$.when(
				$(this).append(
					'\n                <div class="text-tooltip scaleInTooltip">\n                    <div class="tooltip-content">\n                        Some tooltip content\n                    </div>\n                </div>\n            ',
...
function initMediumTextTip() {
	$(".has-medium-text-tip").on("mouseenter", function () {
		if ($(this).find(".text-tip-text").width() >= 345) {
			var e = $(this).find(".text-tip-text").text();
			$.when(
				$(this).append(
					'\n                <div class="text-tooltip scaleInTooltip">\n                    <div class="tooltip-content">\n                        Some tooltip content\n                    </div>\n                </div>\n            ',
...
function setThemeToLocalStorage(e) {
...
function initDarkMode() {
	...
	$(".landing-page-wrapper").length ||
		(null != e &&
			null != e &&
			(setThemeToLocalStorage(e),
			"dark" === e && $(".dark-mode input").prop("checked", !1),
			$(document).trigger("themeChange", e))),
		$(".dark-mode input").on("change", function () {
			!0 === $(this).prop("checked")
				? ($("html, body").removeClass("is-dark"),
				  $(".theme-image").each(function () {
						var e = $(this).attr("data-light");
						$(this).attr("src", e);
				  }),
...
function initAnimatedCheckboxes() {
	$(".animated-checkbox input").each(function () {
		var e = $(this);
		$(this).closest(".animated-checkbox").hasClass("is-checked")
			? ($(this).closest(".animated-checkbox").addClass("is-checked"),
			  e
					...
					.addClass("is-opaque"),
			  setTimeout(function () {
					e.closest(".animated-checkbox").removeClass("is-unchecked");
			  }, 150))
			: ($(this)
					.closest(".animated-checkbox")
...
function initTextFilter() {
	var e;
	$(".textFilter-input").length &&
		((e = $(".textFilter-input").val()),
		$(".textFilter-input")
			.focus(function (i) {
				$(this).val() === e && $(this).val("");
			})
			...
			.keyup(function (e) {
				var i = $(this).val().toLowerCase().split(" ");
				i.length &&
					$(".textFilter-target")
						.hide()
						.filter(function () {
							for (
								var e = $(this).find(".textFilter-match").text().toLowerCase(),
									s = 0;
								s < i.length;
								s++
							)
								if (-1 === e.indexOf(i[s])) return !1;
							return !0;
						})
						.show();
			}));
...
function initCustomTextFilter() {
	$(".custom-text-filter").length &&
		$(".custom-text-filter").each(function () {
			var e = $(this).attr("data-filter-target"),
				i = $(this).val();
			$(this)
				.focus(function (e) {
					$(this).val() === i && $(this).val("");
...
function initPlayers() {
	if ($(".video-player").length)
		if ("development" === env) {
			...
			Array.from(document.querySelectorAll(".bulkit-player")).map(function (e) {
				return new Plyr(e);
			});
		} else
			Array.from(document.querySelectorAll(".bulkit-player")).map(function (e) {
...
function initSingleAccordion() {
	$(".single-accordion .accordion-header").on("click", function () {
		$(this).closest(".single-accordion").hasClass("is-exclusive")
			? $(this).hasClass("is-active")
				...
				$.getJSON("assets/data/search.json", function (i) {
					if (
						(e
							...
							.remove(),
						$.each(i, function (i, t) {
							if (-1 != t.name.search(s) || -1 != t.position.search(s))
								if (null != t.pic) {
									var a =
										'\n                                    <a class="search-result">\n                                        <div class="h-avatar is-small">\n                                            <img class="' +
										("user" === t.type ? "avatar" : "article") +
										'" src="' +
										t.pic +
										'" alt="">\n                                        </div>\n                                        <div class="meta">\n                                            <span>' +
										t.name +
										...
										t.position +
										"</span>\n                                        </div>\n                                    </a>\n                                ";
									e.find(".search-results").append(a);
								} else {
									var o = new Array(
											"is-danger",
											"is-info",
						...
						0 === $(".search-result").length)
					) {
						e.find(".search-results").append(
					...
					"" === i
						? e.find(".search-results").removeClass("is-active")
						: e.find(".search-results").addClass("is-active");
			});
		});
}
	...
	$(".datatable-filter-cell")
		...
		$(".is-datatable tbody td .checkbox input").on("change", function () {
			$(this).closest("tr").toggleClass("is-selected"),
				$(".is-datatable td .checkbox input:checked").length > 0
...
function initTabbedWidgets() {
	$(".tabbed-widget .tabbed-control").on("click", function () {
		var e = $(this).closest(".tabbed-widget");
		$(this).hasClass("is-active") ||
			($(this).siblings(".tabbed-control").removeClass("is-active"),
			$(this).addClass("is-active"),
			e.find(".inner-list-wrapper").toggleClass("is-active"));
	});
}
